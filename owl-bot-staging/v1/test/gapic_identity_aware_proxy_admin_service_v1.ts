...
describe('v1.IdentityAwareProxyAdminServiceClient', () => {
    ...
    describe('createTunnelDestGroup', () => {
        it('invokes createTunnelDestGroup without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.iap.v1.TunnelDestGroup());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createTunnelDestGroup as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getTunnelDestGroup', () => {
        it('invokes getTunnelDestGroup without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.iap.v1.GetTunnelDestGroupRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getTunnelDestGroup as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteTunnelDestGroup', () => {
        it('invokes deleteTunnelDestGroup without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.iap.v1.DeleteTunnelDestGroupRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteTunnelDestGroup as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateTunnelDestGroup', () => {
        it('invokes updateTunnelDestGroup without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.iap.v1.UpdateTunnelDestGroupRequest());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateTunnelDestGroup as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listTunnelDestGroups', () => {
        it('invokes listTunnelDestGroups without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.iap.v1.ListTunnelDestGroupsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listTunnelDestGroups as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
